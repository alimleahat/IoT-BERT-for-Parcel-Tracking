> Historical project write-up. For current setup instructions and the scope of reported results, start with the [README](../README.md). Relative paths below refer to the repository root.
